...
{
    [Activity(Label = "ASolute Transport", Icon = "@drawable/appIcon", Theme = "@style/MyTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
    public class MainActivity : global::Xamarin.Forms.Platform.Android.FormsAppCompatActivity
    {
        ...
        {
            Ultis.Settings.App = "Transport";
            TabLayoutResource = Transport.Droid.Resource.Layout.Tabbar;
            ToolbarResource = Transport.Droid.Resource.Layout.Toolbar; ;
